    ...
    render () {
        ...
        return (
            <div>
                ...
                <div>Keskiarvo {((this.state.hyva - this.state.huono)
                    /(this.state.hyva + this.state.neutraali + this.state.huono)).toPrecision(1)}</div>
                <div>positiivisia {((this.state.hyva 
                / (this.state.hyva + this.state.neutraali + this.state.huono) * 100)).toPrecision(3)} %</div>
            </div>
        )
    }
}
